...
//                dataArray.append("https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1596793418883&di=200a07c42e99a822e4414422b51f03fa&imgtype=0&src=http%3A%2F%2Fimg.mp.itc.cn%2Fupload%2F20160909%2F8e3f3181a20a41cb991b6c5b6d0e7aa3_th.gif")
        //        dataArray.append("http://i-2-yxdown.715083.com/2014/11/14/0372d212-9a73-44ce-bb27-6beae4a237cc.jpg?imageView2/2/q/85")
                ...
                dataArray.append("https://pixabay.com/get/55e6d6444c5ba414ead98d7fc02c3f7a1322dfe353577241762b7cd7.jpg")
                dataArray.append("https://pixabay.com/get/53e5d5424853ac14ead98d7fc02c3f7a1322dfe35357754f712b7ed5.jpg")
                dataArray.append("https://pixabay.com/get/55e6dd424955aa14ead98d7fc02c3f7a1322dfe353577241762e7bd6.jpg")
//        dataArray.append("https://pixabay.com/get/54e8d7414f5baf14ead98d7fc02c3f7a1322dfe353577241762d7dd1.jpg")
...
extension ViewController : UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        //                cell.imageView.kf.setImage(with: URL.init(string: dataArray[indexPath.row]));
                                cell.imageView.sd_setImage(with: URL.init(string: dataArray[indexPath.row]))
...
extension ViewController : KWImageBrowserProtocol {
    ...
    func kw_loadThumbImage(
        ...
        SDWebImageManager.shared.loadImage(with: URL(string: url), options: [.fromLoaderOnly], progress: { receivedSize, expectedSize, targetURL in
    ...
    func kw_loadLargeImage(
        ...
        let url = dataArray[index]
                ...
                SDWebImageManager.shared.loadImage(with: URL(string: url), options: [.progressiveLoad], progress: { receivedSize, expectedSize, targetURL in
                    progress?(Float(receivedSize), Float(expectedSize))
                }, completed: { image, data, error, cacheType, finished, imageURL in
                    print(image)
                    completedBlock?(image, data, error, finished)
